					...
					<!--mobile dropdown menu-->
						...
						<div class="col-lg-12">
							<nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
								<h4 class="title float-left">Question Asked By Students In Different Courses</h4>
							...
							<div class="my_course_content_container">
								...
								<div class="my_setting_content mb30" style="width:1000px">
									...
									<div class="col-lg-12" style="text-align:center;">
										<div class="col-lg-12" style="text-align:center;">
											<input type="submit" class="my_setting_savechange_btn btn btn-thm" name="save" value="Submit"/>
									  </div>
									</div>
								</div>
							</form>
