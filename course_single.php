	...
	if(isset($_POST['buy']))
	{
		...
		else
		{
			...
			if(isset($_GET['c_id']))
			{
				...
				echo $qs="insert into student_course (stu_id,course_id)values('$stu_id','$course_id')";
				mysqli_query($con,$qs);
...
<div class="wrapper">
			...
			<div class="row">
				<div class="col-xl-6 offset-xl-3 text-center">
					<div class="breadcrumb_content">
						<h4 class="breadcrumb_title">Course Sıngle</h4>
						<ol class="breadcrumb">
						    <li class="breadcrumb-item"><a href="#">Home</a></li>
						    <li class="breadcrumb-item active" aria-current="page">Course Sıngle</li>
						</ol>
					</div>
				</div>
			</div>
	...
	<section style="margin-left:100px;"class="blog_post_container">
		<div class="container" >
			<div class="row">
					...
					<form method="post" >
						...
						<?php
							if(isset($_GET['c_id']))
							{
								...
								$qs="select * from course left join teacher on crs_teach_id=teacher_id where course_id='$x'";
								
								$data=mysqli_query($con,$qs);
								$row=mysqli_fetch_array($data);
						?>
							<div class="details pt0">
								<h3 class="mb25">Course Details</h3>
							</div>
							<div  >
								<img class="img-fluid" src="photo/<?php echo $row['course_image']; ?>" alt="image" style="width:700px;height:400px; border:5px solid silver;margin-left:100px;border-radius:20px 0px;">
								
							</div>
							<div align="center"style="margin:10px;font-size:20px">
								<a href="#"><button style="border-radius:8px;background-color:orange;color:white;width:100px;height:50px;border:5px solid skyblue;"name="buy">Buy</button></a>
							</div>
							<br/><br/><br/><br/>
							<div class="details">
								<h1 align="left">Course Description</h1>
								<p align="left"><?php echo $row['description']; ?></p>
								
								
								<br/><br/>
								<div>
									<h2 class="mb0">Eligibility</h2>
									<ul class="bs_content_list">
										<li><p><b><?php echo $row['eligibility']; ?></b></p></li>
									</ul>
									
									<h2 class="mb0">Course Name</h2>
									<ul class="bs_content_list">
										<li><p><?php echo $row['course_name']; ?></p></li>
									</ul>
									
									<h2 class="mb0">Course Price</h2>
									<ul class="bs_content_list">
										<li><p> <?php echo $row['course_price']; ?></p></li>
									</ul>
									
									<h2 class="mb0">Course Duration</h2>
									<ul class="bs_content_list">
										<li><p><?php echo $row['course_duration']; ?></p></li>
									</ul>
									
									<h2 class="mb0">Teacher Name</h2>
									<ul class="bs_content_list">
										<li><p><?php echo $row['teacher_name']; ?></p></li>
									</ul>
					...
					<div class="main_blog_post_widget_list">
						...
						<div class="event_details_widget">
							...
							<ul>
								...
								<li><span class="flaticon-email"></span> event@edumy.com</li>
