                                ...
                                <table class="table table-bordered" width="100%" border="1" cellspacing="0">
																	...
																	<tbody>
																		...
																		<tr>
																			<td colspan="4">
																					<div class="card-body text-left">
																						...
																						src="../motion/photo/<?php echo $row['stu_photo']; ?>">
																					 ...
																					 <div class="card-body text-left">
																						...
																						<img id="si" alt="your image" style="width:150px;height:150px" class="img-account-profile rounded-square mb-2" 
																						src="../motion/photo/<?php echo $row['signature']; ?>">
																		...
																		<tr>
																			...
																			<td colspan="2">
																			<?php
																				$qs="select * from course right join student on course_id=course where stu_id='$x'";
																				
																				$data1=mysqli_query($con,$qs);
