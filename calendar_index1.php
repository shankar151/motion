...
<?php
	...
	if(isset($_POST['save']))
	{
		...
		$qs="insert into calendar(stu_id,cal_date,event)values('$stu_id','$calr','$event')";
...
<!-- HTML5 shim and Respond.js for IE8 support of HTML5 elements and media queries -->
    ...
    <![endif]-->
		...
		<link href="css/motion_css/calendar.css" type="text/css" rel="stylesheet" />
</head>
<body>
<div class="wrapper">
				...
				<div class="col-sm-12 col-lg-8 col-xl-10">
					...
					<div class="col-lg-12">
							<nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
								<h4 class="title float-left">Set Calendar Events</h4>
								...
								<form method="post" enctype="multipart/form-data">
									<div align="center" style="">
										<h3>Date and Events</h3>
										<div class="row">
											<div class="col">
												<input type="date" class="form-control h50" name="calr">
											</div>
											
											<div class="col">
												<input type="text" class="form-control h50" name="event">
											</div>
										</div>
									</div>
									...
									<div align="center">
									<input class="btn btn-lg btn-success type="submit" value="Assig Events" name="save">
									</div>
								</form>
								<br/><br/>
								<?php
					...
					<table align="center" border="1">
						...
						<?php 
							$qs="select * from calendar inner join student on calendar.stu_id=student.stu_id";
