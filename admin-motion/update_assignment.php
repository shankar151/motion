		...
		if(isset($_GET['upd']))
			{
				...
				$qs="select * from assignment left join course on assig_course_id=course_id where assig_id='$x'";
				
				$data=mysqli_query($con,$qs);
				$row=mysqli_fetch_array($data);
				
				$assig_title=$row['assig_title'];
				$assig_submit_date=$row['assig_submit_date'];
				$pic=$row['pdf'];
		
				/* isme $course_id course table ka column hai 
					aur $row['assig_course_id']; assignment table ka column hai 
					course table ke course_id ko assignment table ke assig_course_id se match kara ke print karwate hai.
				*/
				$course_id=$row['assig_course_id'];
				...
				if(isset($_POST['update']))
				{
					...
					if($pic=="")
					{
						echo $qs="update assignment set assig_course_id='$assig_course_id',assig_title='$assig_title',assig_submit_date='$assig_submit_date' where assig_id='$x'";
					}
					else
					{
						echo $qs="update assignment set assig_course_id='$assig_course_id',assig_title='$assig_title',assig_submit_date='$assig_submit_date',pdf='$pic' where assig_id='$x'";
					}
					...
					<!--mobile dropdown menu-->
						...
						<div class="col-lg-12">
							<nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
								<h4 class="title float-left">Update Assignment</h4>
										...
										<div class="col-xl-12">
											<div class="row">
												<div class="col-xl-6">
													<div class="my_profile_setting_input form-group">
												    	...
												    	<input type="hidden" class="form-control" id="formGroupExampleInput1" placeholder="UX/UI" name="assig_course_id">
															...
															<!--For print courses on the update page-->
																<?php
																	 $qs="select * from course left join assignment on course_id=assig_course_id ";
																	$data=mysqli_query($con,$qs);
												...
												<div class="col-xl-6">
													<div class="my_profile_setting_input form-group">
												    	...
												    	<input type="text" class="form-control" id="formGroupExampleInput3" placeholder="$89" name="assig_title" value="<?php echo $assig_title; ?>" required>
													</div>
												</div>
											</div>
											...
											<div class="row">
													...
													<div class="my_profile_setting_input form-group">
												    	...
												    	<input type="date" class="form-control" name="assig_submit_date" value="<?php echo $assig_submit_date; ?>" required>
													</div>
													</div>
													...
													<div class="my_profile_setting_input form-group">
												    	<label for="formGroupExampleInputX">PDF</label>
															...
															<input type="file" class="form-control" name="pdf" required><span><?php echo $pic; ?></span>
													</div>
												</div>
												</div>
