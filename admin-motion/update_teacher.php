<?php
		...
		if(isset($_GET['upd']))
			{
				...
				$qs="select * from teacher where teacher_id='$x'";
		...
		if(isset($_POST['update']))
		{
			...
			echo $qs="update teacher set teacher_name='$teacher_name',teacher_qualification='$teacher_qualification',teacher_subject='$teacher_subject',teacher_subject='$teacher_subject' where teacher_id='$teacher_id'";
					...
					<!--mobile dropdown menu-->
						...
						<div class="col-lg-12">
							<nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
								<h4 class="title float-left">Update Teacher Details</h4>
									...
									<div class="row my_setting_content_details pb0">
										<div class="col-xl-12" style="width:1000px">
											<div class="row">
												<div class="col-xl-6">
													...
													<div class="my_profile_setting_input form-group">
												    	<label for="formGroupExampleInput1">Teacher name</label>
												    	<input type="hidden" class="form-control" id="formGroupExampleInput1" placeholder="UX/UI" name="teacher_id" value="<?php echo $row['teacher_id']; ?>">
															<input type="text" class="form-control" id="formGroupExampleInput1" placeholder="UX/UI" name="teacher_name" value="<?php echo $row['teacher_name']; ?>"required>
													</div>
												...
												<div class="col-xl-6">
													<div class="my_profile_setting_input form-group">
												    	<label for="formGroupExampleInput3">Teacher Qualification</label>
												    	<input type="text" class="form-control" id="formGroupExampleInput3" placeholder="$89" name="teacher_qualification" value="<?php echo $row['teacher_qualification']; ?>" required>
													</div>
												</div>
											</div>
											...
											<div class="row">
													<div class="col-xl-6">
													<div class="my_profile_setting_input form-group">
												    	<label for="exampleInputPhone">Teacher Subject</label>
												    	<input type="text" class="form-control" name="teacher_subject" value="<?php echo $row['teacher_subject']; ?>"required>
													</div>
													</div>
