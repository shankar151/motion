<?php
		...
		if(isset($_GET['upd']))
		{
			...
			$qs="select * from manage_unit inner join course on select_course=course_id where mu_id='$x'";
		...
		if(isset($_POST['update']))
		{
			...
			$qs="update manage_unit set select_course='$course_id',unit_name='$unit_name',unit_sr_no='$unit_sr_no' where mu_id='$x'";
					...
					<!--mobile dropdown menu-->
						...
						<div class="col-lg-12">
							<nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
								<h4 class="title float-left">Update Unit</h4>
											...
											<div class="row">
															...
															<select name="course_id" class="form-control" >
																<?php
																	...
																	while($row=mysqli_fetch_array($data,MYSQLI_BOTH))
																	{
																		...
																		if($row1['select_course']==$row['course_id'])
																		{
												...
												<div class="col-xl-6">
													<div class="my_profile_setting_input form-group">
												    	...
												    	<input type="text" class="form-control" id="formGroupExampleInput3" placeholder="Unit name" name="unit_name" value="<?php echo $row1['unit_name']; ?>" required>
													</div>
												</div>
											</div>
											...
											<div class="row">
													...
													<div class="my_profile_setting_input form-group">
												    	<label for="formGroupExampleInputX">Unit Sr No.</label>
															...
															<input type="text" class="form-control" name="unit_sr_no" placeholder="Unit sr no." value="<?php echo $row1['unit_sr_no']; ?>" required>
													</div>
												</div>
												</div>
