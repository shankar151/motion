<?php
		...
		if(isset($_POST['save']))
		{
			...
			$qs = "select * from course where course_name = '$course_name'";
			...
			{
			echo $qs="insert into course(course_image,course_name,course_price,course_duration,crs_teach_id,eligibility,description)values('$pic','$course_name','$course_price','$course_duration','$teacher_id','$eligibility','$description')";
										...
										<div class="col-xl-12">
											<div class="row">
												<div class="col-xl-6">
													<div class="my_profile_setting_input form-group">
												    	...
												    	<input type="hidden" class="form-control" id="formGroupExampleInput1" placeholder="UX/UI" name="course_id">
															<input type="text" class="form-control" id="formGroupExampleInput1" placeholder="UX/UI" name="course_name" required>
															<span><font color="red"><?php echo $msg; ?></font></span>
													</div>
												...
												<div class="col-xl-6">
													<div class="my_profile_setting_input form-group">
												    	...
												    	<input type="text" class="form-control" id="formGroupExampleInput3" placeholder="$89" name="course_price" required>
													</div>
												</div>
											</div>
											...
											<div class="row">
													...
													<div class="my_profile_setting_input form-group">
												    	<label for="formGroupExampleInputX">Teacher name</label>
															...
															<select name="teacher_id" class="form-control" value="<?php echo $teacher_name; ?>">
																<?php
											...
											<div class="row">
												<div class="col-xl-6">
													<div class="my_profile_setting_input form-group">
												    	<label for="formGroupExampleInput1">Eligiblity</label>
															<input type="text" class="form-control" id="formGroupExampleInput1" placeholder="Eligiblity" name="eligibility" required>
													</div>
												...
												<div class="col-xl-6">
													<div class="my_profile_setting_input form-group">
												    	<label for="formGroupExampleInput1">Description</label>
															<textarea rows="1000" cols="1000" class="form-control" id="formGroupExampleInput1" placeholder="Description" name="description" required></textarea>
													</div>
												...
												<div class="row">
													<div class="col-xl-6">
														<div class="my_profile_setting_input form-group">
																<label for="formGroupExampleInput1">Course Image</label>
